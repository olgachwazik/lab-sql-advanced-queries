...
-- interesting thing to notice that when we use CTE, it looks like the result is not restricted by the Limit to X rows. 
...
-- query yo get the highest films_starred for each film (to be used as CTE)
